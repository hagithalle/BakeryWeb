...
namespace Server.Migrations
{
    ...
    [Migration("20260223210911_AddOverheadCategoryEnumToOverheadItem")]
    partial class AddOverheadCategoryEnumToOverheadItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.Product", b =>
                {
                    ...
                    b.Property<decimal?>("ManualSellingPrice")
                        .HasColumnType("numeric");
                    ...
                    b.Property<int>("SaleUnitType")
                        .HasColumnType("integer");

                    b.Property<int>("UnitConversionRate")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Server.Models.RecipeItem", b =>
                {
                    ...
                    b.Property<int>("ComposingRecipeId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Server.Models.RecipeItem", b =>
                {
                    b.HasOne("Server.Models.Recipe", "BaseRecipe")
                        .WithMany()
                        .HasForeignKey("BaseRecipeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Server.Models.Recipe", "ComposingRecipe")
                        .WithMany("BaseRecipes")
                        .HasForeignKey("ComposingRecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BaseRecipe");

                    b.Navigation("ComposingRecipe");
                });
